...
def create_categories(apps, schema_editor):
    ...
    RevenueCategory.objects.bulk_create(
        [
            ...
            RevenueCategory(name="Investimentos", description="Categoria de despesa de Investimentos"),
            RevenueCategory(name="Lazer", description="Categoria de despesa de Lazer"),
            RevenueCategory(name="Presentes", description="Categoria de despesa de Presentes"),
            RevenueCategory(name="Mercado", description="Categoria de despesa de Mercado"),
            RevenueCategory(name="Pets", description="Categoria de despesa de Pets"),
            RevenueCategory(name="Restaurantes", description="Categoria de despesa de Restaurantes"),
            RevenueCategory(name="Saúde", description="Categoria de despesa de Saúde"),
            RevenueCategory(name="Transporte", description="Categoria de despesa de Transporte"),
            RevenueCategory(name="Viagem", description="Categoria de despesa de Viagem"),
            RevenueCategory(name="Outros", description="Categoria de despesa de Outros"),
        ]
    )
